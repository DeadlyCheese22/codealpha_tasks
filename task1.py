...
try:
   ...
   # The store parameter is set to 0, which means it doesn't store packets in memory, and the count parameter is set to 10, which specifies the number of packets to sniff.
